...
try{
  ...
  $conexion->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
    ...
    $sql = $conexion->prepare("INSERT INTO respuesta VALUES
    (NULL, :respuesta, :idPregunta, :dni)");

   $sql->bindValue(':respuesta',$_POST['mensaje']);
   $sql->bindValue(':idPregunta', $_GET['id']);
   ...
   if(!$result){
     ...
     echo "Error al añadir una respuesta" ;
   }else{
     header("Location: foro.php");
     //header("Location: foro.php?msg=newr");
   }
