...
<head>
<meta charset="utf­8">
<title>Pr&aacute;ctica Evaluable II</title>
...
<figure >
<img src = "imagenes/logo1.jpg" alt = "figura de ejemplo" width="100%" />
</figure>
</section>

<section class="menuportada">
  <ul>
...
<?php if(isset($_GET["msg"]) && $_GET["msg"]=='new'){ ?>
  <script> alert("Enhorabuena! Te has convertido en un nuevo miembro de nuestro centro deportivo")</script>
<?php } ?>

<?php if(isset($_GET["msg"]) && $_GET["msg"]=='add'){ ?>
  <script> alert("El usuario o la contraseña no son correctos")</script>
<?php } ?>
